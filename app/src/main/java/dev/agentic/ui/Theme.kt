...
// Component chips (repo/skill/plugin/mcp) draw from the SAME families: cyan for every toggleable
// component kind (skill/plugin/mcp — matching the skill tags in the transcript), blue for repos.
// The old green/purple chip-only families were removed when the chips were unified on cyan.
